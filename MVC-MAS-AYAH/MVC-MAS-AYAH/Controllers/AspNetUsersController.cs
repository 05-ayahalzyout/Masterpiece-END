...
namespace MVC_MAS_AYAH.Controllers
{
    public class AspNetUsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Email,EmailConfirmed,PasswordHash,SecurityStamp,PhoneNumber,PhoneNumberConfirmed,TwoFactorEnabled,LockoutEndDateUtc,LockoutEnabled,AccessFailedCount,UserName,Role,Balance,Name")] AspNetUser aspNetUser)
        {
